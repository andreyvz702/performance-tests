...
open_deposit_account_response = httpx.post(f"http://localhost:8003/api/v1/accounts/open-deposit-account",
                                          json=open_deposit_account_payload)
open_deposit_account_response_data = open_deposit_account_response.json()

print("Open deposit account data:", open_deposit_account_response_data)
