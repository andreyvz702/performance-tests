...
operation_receipt_response = httpx.get(f'http://localhost:8003/api/v1/operations/operation-receipt/'
                                       f'{make_purchase_operation_response_data["operation"]["id"]}')
operation_receipt_response_data = operation_receipt_response.json()

print('Operation receipt response data: ', operation_receipt_response_data)
# print('Operation receipt response status code: ', operation_receipt_response.status_code)