...
print('Make top up operation response data: ', make_top_up_operation_response_data)
print('Make top up operation response status code: ', make_top_up_operation_response.status_code)
